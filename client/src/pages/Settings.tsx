...
export default function Settings() {
  ...
  const handleAddKey = (e: React.FormEvent) => {
    ...
    createKey({
      ...
      userId: "temp", // Backend handles real user ID from auth context
    }, {
      onSuccess: () => {
            ...
            <form onSubmit={handleAddKey} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <button 
                  ...
                  className="px-6 py-2 bg-primary text-primary-foreground text-sm font-bold rounded-lg hover:bg-primary/90 transition-colors disabled:opacity-50"
                >
                  {isCreatingKey ? "جاري الإضافة..." : "حفظ المفتاح"}
                </button>
              </div>
            </form>
          </Dialog.Content>
